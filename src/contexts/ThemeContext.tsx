...
function applyTheme(s: ThemeSettings) {
  ...
  if (isDark) {
    root.setProperty('--session-class-bg',          '#166534')
    root.setProperty('--session-class-title',        '#f0fdf4')
    root.setProperty('--session-class-sub',          '#bbf7d0')
    root.setProperty('--session-appointment-bg',     '#1e40af')
    root.setProperty('--session-appointment-title',  '#eff6ff')
    root.setProperty('--session-appointment-sub',    '#bfdbfe')
    root.setProperty('--session-event-bg',           '#9a3412')
    root.setProperty('--session-event-title',        '#fff7ed')
    root.setProperty('--session-event-sub',          '#fed7aa')
    root.setProperty('--session-challenge-bg',       '#6b21a8')
    root.setProperty('--session-challenge-title',    '#faf5ff')
    root.setProperty('--session-challenge-sub',      '#e9d5ff')
  } else {
