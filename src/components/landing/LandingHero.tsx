...
export function LandingHero() {
  return (
    <section
      className="relative overflow-hidden bg-black h-[100svh] sm:h-[calc(100svh-4rem)] sm:mt-16"
    ...
    >
      ...
      {/* Mobile bottom fade (unchanged) */}
      <div className="sm:hidden absolute inset-x-0 bottom-0 h-96 bg-gradient-to-t from-black from-40% via-black/95 via-70% to-transparent pointer-events-none z-10" />
      <div className="sm:hidden absolute inset-x-0 bottom-0 h-80 bg-gradient-to-t from-black from-20% via-black/80 via-50% to-transparent pointer-events-none" />

      {/* Desktop bottom fade (smaller) */}
