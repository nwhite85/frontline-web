...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ChevronDownIcon className="relative top-px ml-1 size-3 transition duration-300 group-data-[state=open]/navigation-menu-trigger:rotate-180 group-data-popup-open/navigation-menu-trigger:rotate-180" aria-hidden="true" />
    </NavigationMenuPrimitive.Trigger>
  )
}
...
function NavigationMenuViewport({
  ...
  return (
    <div
      className={cn(
        "absolute top-full left-0 isolate z-[300] flex justify-center"
      )}
    >
