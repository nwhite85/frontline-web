      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm flex flex-col items-center gap-6 text-center">
          ...
          <div>
            ...
            <p className="text-white/50 mt-2">Your account has been created. Welcome to Frontline Fitness.</p>
          </div>
          <Button asChild className="w-full"><a href="/login">Sign in to your account</a></Button>
        </div>
      </div>
