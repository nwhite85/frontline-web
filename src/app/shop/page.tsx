...
export default function ShopPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col relative overflow-hidden">
      ...
      {/* Product grid */}
      <div className="relative z-10 flex-1 w-full max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 pb-16">
        {loading ? (
                  ...
                  {product.image_url ? (
                    <>
                      <img
                        ...
                        alt={product.name}
                        className="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 group-hover:opacity-0 scale-[1.15] [object-position:center_15%]"
                      />
                      {product.image_urls && product.image_urls[1] && (
                        <img
                          src={product.image_urls[1]}
                          alt={`${product.name} back`}
                          className="absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-500 group-hover:opacity-100 scale-[1.15] [object-position:center_15%]"
                        />
                      )}
                    </>
                  ) : (
